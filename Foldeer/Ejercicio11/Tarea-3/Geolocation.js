class Geolocation{
    ...
    obtener(){
    navigator.geolocation.getCurrentPosition(this.mostrar.bind(this),this.errores);
    }
    ...
    this.getMapaEstaticoGoogle(posicion.coords.latitude, posicion.coords.longitude)
  ...
  getMapaEstaticoGoogle(latitud, longitud) {
    var apiKey = "&key=AIzaSyBhzQukqv5kc1CpS1KQEAyGolUwpLEaf-A";
